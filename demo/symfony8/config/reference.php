 ...
 *     },
 * }
 * @psalm-type NowoYopassConfig = array{
 *     user_class?: scalar|Param|null, // FQCN of the application user entity (must implement UserInterface and expose getId()).
 *     table_prefix?: scalar|Param|null, // Prefix for the secure_shares table/collection (final name: {prefix}secure_shares). // Default: "yopass_"
 *     database?: array{ // Persistence backend. Relational platforms use Doctrine ORM; MongoDB uses Doctrine ODM; custom allows any store.
 *         driver?: "doctrine_orm"|"doctrine_mongodb"|"custom"|Param, // Persistence driver. Use custom with database.repository for Redis, Couchbase, etc. // Default: "doctrine_orm"
 *         platform?: "postgresql"|"mysql"|"mariadb"|"sqlite"|"sqlserver"|"oracle"|"mongodb"|"other"|Param, // Documented platform (postgresql, mysql, mariadb, sqlite, sqlserver, oracle, mongodb, other). // Default: "postgresql"
 *         connection?: scalar|Param|null, // Doctrine DBAL connection name from config/packages/doctrine.yaml. // Default: "default"
 *         entity_manager?: scalar|Param|null, // Doctrine ORM entity manager name for relational databases. // Default: "default"
 *         document_manager?: scalar|Param|null, // Doctrine MongoDB document manager name when platform/driver is mongodb. // Default: "default"
 *         collection?: scalar|Param|null, // MongoDB collection name. Defaults to {table_prefix}secure_shares. // Default: null
 *         repository?: scalar|Param|null, // Service id implementing ShareRepositoryInterface when driver is custom. // Default: null
 *     },
 *     max_ciphertext_bytes?: int|Param, // Maximum accepted ciphertext payload size in bytes. // Default: 700000
 *     max_secret_chars?: int|Param, // Maximum characters allowed in the text secret field (multiline). Must stay within max_ciphertext_bytes after encryption. // Default: 524288
 *     file_handler?: scalar|Param|null, // Service id implementing ShareFileHandlerInterface. When null, the file tab is hidden and file shares are rejected. // Default: null
 *     access_log?: array{ // Records successful public link opens (consume) for the share creator audit trail. Requires Doctrine ORM.
 *         enabled?: bool|Param, // When false, opens are not persisted and the history UI stays hidden. // Default: true
 *     },
 *     route_prefix?: scalar|Param|null, // Optional prefix prepended to all bundle route paths (e.g. /{_locale}). // Default: ""
 *     dashboard_route?: scalar|Param|null, // Optional route name for the back link in the manage UI. Null hides the button. // Default: null
 *     shares?: array{ // Default and allowed expiration / max-read options for new shares.
 *         default_expiration?: scalar|Param|null, // Default expiration option id (must match an expiration_options entry). // Default: "1h"
 *         default_max_reads?: int|Param, // Default max reads (must be listed in max_reads_options). // Default: 1
 *         list_page_size?: int|Param, // Shares shown per page in the manage list. Use 0 to show all shares without pagination. // Default: 20
 *         max_reads_options?: list<int|Param>,
 *         expiration_options?: list<array{ // Default: [{"id":"1h","interval":"1 hour"},{"id":"24h","interval":"24 hours"},{"id":"7d","interval":"7 days"}]
 *             id?: scalar|Param|null, // Stable identifier sent as expiresIn in the create API.
 *             interval?: scalar|Param|null, // PHP relative datetime modifier (e.g. "1 hour", "7 days").
 *         }>,
 *         retention?: array{ // Automatically delete shares older than max_age from the manage list and via the purge console command.
 *             enabled?: bool|Param, // When false, shares are kept until manually deleted or revoked. // Default: true
 *             max_age?: scalar|Param|null, // PHP relative datetime modifier (e.g. "1 month", "30 days"). Shares with createdAt before now − max_age are removed. // Default: "1 month"
 *         },
 *     },
 *     sharing?: array{ // Default encryption and link-sharing options in the manage UI.
 *         default_encryption?: "auto"|"password"|Param, // Default encryption mode: auto-generated key or custom password. // Default: "auto"
 *         allow_custom_password?: bool|Param, // When false, hides the custom password option in the create form. // Default: true
 *         default_embed_in_url?: bool|Param, // Pre-check “include key/password in URL query string” when creating a share. // Default: true
 *         allow_embed_in_url?: bool|Param, // When false, hides the embed-in-URL option (short link only). // Default: true
 *         show_remember_notice?: bool|Param, // Show the one-time / do-not-open-yourself notice after creating a share. // Default: true
 *     },
 *     security?: array{ // Access control. Replace access_checker with a custom service implementing YopassAccessCheckerInterface.
 *         access_checker?: scalar|Param|null, // Service id implementing YopassAccessCheckerInterface. Null uses role-based defaults. // Default: null
 ...
 *     routes?: array{
 *         manage?: array{
 *             path?: scalar|Param|null, // Default: "/tools/yopass"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_index"
 *         },
 *         create?: array{
 *             path?: scalar|Param|null, // Default: "/tools/yopass/create"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_create"
 *         },
 *         revoke?: array{
 *             path?: scalar|Param|null, // Default: "/tools/yopass/{id}/revoke"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_revoke"
 *         },
 *         delete?: array{
 *             path?: scalar|Param|null, // Default: "/tools/yopass/{id}/delete"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_delete"
 *         },
 *         delete_all?: array{
 *             path?: scalar|Param|null, // Default: "/tools/yopass/delete-all"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_delete_all"
 *         },
 *         preview?: array{
 *             path?: scalar|Param|null, // Default: "/tools/yopass/{id}/preview"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_preview"
 *         },
 *         extend?: array{
 *             path?: scalar|Param|null, // Default: "/tools/yopass/{id}/extend"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_extend"
 *         },
 *         created?: array{
 *             path?: scalar|Param|null, // Default: "/tools/yopass/{id}/created"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_created"
 *         },
 *         public_show?: array{
 *             path?: scalar|Param|null, // Default: "/share/{id}"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_public_share"
 *         },
 *         public_consume?: array{
 *             path?: scalar|Param|null, // Default: "/share/{id}/consume"
 *             name?: scalar|Param|null, // Default: "nowo_yopass_public_consume"
 *         },
 *     },
 *     templates?: array{
